...
$queries = array(
  ...
  'create' => array(
                0 => array(
                  ...
                  'user'  => 'CREATE TABLE IF NOT EXISTS `user` (`id` bigint(20) unsigned zerofill NOT NULL AUTO_INCREMENT,`name` varchar(255) COLLATE utf8_bin NOT NULL,`email` varchar(255) COLLATE utf8_bin NOT NULL,`__passwd` varchar(255) COLLATE utf8_bin NOT NULL,`status` enum(\'STUDENT\',\'MODERATOR\',\'ADMINISTRATOR\') COLLATE utf8_bin DEFAULT \'STUDENT\',`token` varchar(255) COLLATE utf8_bin DEFAULT \'\',PRIMARY KEY (`id`),UNIQUE KEY `name` (`name`),UNIQUE KEY `email` (`email`),KEY `status` (`status`),KEY `token` (`token`)) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_bin;',
                ),
                1 => array(
  ...
  'insert' => array(
                0 => array(
                  'user' => array('INSERT INTO `user` VALUES(NULL, ?, ?, ?, ?, NULL);', 'ssss'),
